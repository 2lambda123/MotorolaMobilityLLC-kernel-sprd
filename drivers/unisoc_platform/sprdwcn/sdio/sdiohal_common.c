...
void sdiohal_debug_point_show(void)
{
	...
	pr_info("Last xmit_lock: Enter task(%s) caller: %ps->%ps->%ps->%ps, time=%llu\n",
		p_data->sdcb.op_enter_comm, p_data->sdcb.op_enter_builtin_addr[3],
		p_data->sdcb.op_enter_builtin_addr[2], p_data->sdcb.op_enter_builtin_addr[1],
		p_data->sdcb.op_enter_builtin_addr[0], p_data->op_enter_ns);
	pr_info("Last xmit_lock: Leave task(%s) caller: %ps->%ps->%ps->%ps, time=%llu\n",
		p_data->sdcb.op_leave_comm, p_data->sdcb.op_leave_builtin_addr[3],
		p_data->sdcb.op_leave_builtin_addr[2], p_data->sdcb.op_leave_builtin_addr[1],
		p_data->sdcb.op_leave_builtin_addr[0], p_data->op_leave_ns);
...
void sdiohal_op_enter(void)
{
	...
	p_data->sdcb.op_enter_builtin_addr[3] = __builtin_return_address(3);
	p_data->sdcb.op_enter_builtin_addr[2] = __builtin_return_address(2);
	p_data->sdcb.op_enter_builtin_addr[1] = __builtin_return_address(1);
...
void sdiohal_op_leave(void)
{
	...
	p_data->sdcb.op_leave_builtin_addr[3] = __builtin_return_address(3);
	p_data->sdcb.op_leave_builtin_addr[2] = __builtin_return_address(2);
	p_data->sdcb.op_leave_builtin_addr[1] = __builtin_return_address(1);
