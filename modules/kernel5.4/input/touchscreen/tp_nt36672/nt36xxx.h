 ...
 */
#define NVT_PATCH_COMERR_PM                 1
#define NVT_TIMEOUT_COMERR_PM               700
...
extern void nvt_eic_irq_disable(void);
extern void nvt_eic_irq_enable(void);
extern int nvt_pinctrl_select_irq_eic(struct nvt_ts_data  *ts);
extern int nvt_pinctrl_select_irq_gpio(struct nvt_ts_data  *ts);
