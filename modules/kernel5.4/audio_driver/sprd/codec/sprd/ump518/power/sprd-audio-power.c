...
static int __init sprd_audio_power_regulator_init_518(void)
{
	return platform_driver_register(&sprd_audio_power_driver);
}

subsys_initcall_sync(sprd_audio_power_regulator_init_518);
...
MODULE_ALIAS("platform:sprd-audio-power-518");
MODULE_LICENSE("GPL");
